    ...
    return (
        <Suspense fallback={null}>
            ...
            <div className="flex flex-col items-start overflow-x-hidden h-screen">
                ...
                <div
                    ref={bodyRef}
                    className="flex flex-col flex-1 items-center justify-start w-screen h-full overflow-y-auto overflow-x-hidden z-0 pt-4 sm:pt-8 px-4 md:pt-10 pb-4 main-container-section"
                >
                    <Popups />
                    {/* <Polling /> */}
                    <Web3ReactManager>
